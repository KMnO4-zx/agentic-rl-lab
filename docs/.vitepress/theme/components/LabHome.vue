  ...
  <main class="lab-home">
    <section class="lab-hero lab-width">
      <div class="hero-copy">
        ...
        <p class="hero-description">{{ t('LLM 与 Agent 强化学习实战笔记。', 'Hands-on LLM and agent reinforcement learning. ') }}<br>{{ t('读懂算法，跑通代码，在实验里找到答案。', 'Read the method, run the code, inspect the results.') }}</p>
